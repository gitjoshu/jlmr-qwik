...
export default component$(() => {
  return (
        ...
        <div class="px-4 py-5 mx-auto max-w-6xl lg:px-8 lg:py-10 grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
